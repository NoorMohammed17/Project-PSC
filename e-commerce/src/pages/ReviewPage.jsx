...
import img from "../assets/HD-logo.png"
        ...
        <div>
           ...
           //border='2px solid pink'
             direction={['column', 'column', 'row']} spacing={'25px'} margin={'auto'} width={{ base: '100%', md: '100%', lg: '95%' }} mb={'20px'}>
                ...
                <Box width={{ base: '20%', lg: '20%' }} justify={{ base: "center", lg: "flex-start" }} height={'220px'}   
                 //border={'1px solid teal'}
                 > 
                <Image src={img} alt={'logo'} width={'100%'} objectFit="cover" objectPosition="center"
