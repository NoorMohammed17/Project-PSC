    ...
    return (
        <div>
           ...
           //border='2px solid pink'
             direction={['column', 'column','column', 'row']} spacing={'25px'} margin={'auto'} width={{ base: '100%', md: '100%', lg: '95%' }} mb={'20px'}>

                <Box width={{ base: '40%', lg: '20%' }} justifyContent={{ base: "center", lg: "flex-start" }} alignItems={'center'} height={'220px'}   
            ...
            <Stack direction={['column', 'row']} justifyContent={'center'} margin={'auto'} spacing={'24px'}
                ...
                <Stack width={'95%'} spacing={'20px'} direction={['column', 'column']}>
                    ...
                    <Flex width={'100%'} alignItems={'center'} >
                        <Spacer /><Button colorScheme='blue' size={'lg'} px={'20'} onClick={handlePlaceOrder}>Place Order</Button>
                    </Flex>
                </Stack>


                <Stack width={{ base: '100%', md: '100%', lg: '30%' }} height={'auto'} direction={['column', 'column']} spacing={'20px'}>
