...
const Checkout = () => {
    ...
    return (
        <div>
            <Stack border='2px solid pink' direction={['column', 'column', 'row']} spacing={'25px'} margin={'auto'} width={{ base: '100%', md: '100%', lg: '95%' }} mb={'20px'}>
                ...
                <Stack width={{ base: '100%', md: '100%', lg: '95%' }} direction={['column', 'column']}>
                    ...
                    <FormControl >
                        <Stack width={'100%'} p={5} border={'0.1px solid gray'} mb={'40px'} borderRadius={5}>
                            ...
                            <Input placeholder='' borderRadius={'none'} name='firstname' value={data.firstname} onChange={(e) => { handleChange(e) }} />
                                ...
                                <CardBody>
                                    ...
                                    <RadioGroup >
                                        <Stack spacing='5'>
                                            <Box>
                                                <Flex>
                                                    <Radio size='lg' value='Free Shipping @ $59' name={'order'} onChange={(e) => { handleChange(e) }}></Radio>
                                                    <Box ml='3'>
                        ...
                        <Flex width={'100%'} alignItems={'center'} >
                            <Spacer /><Button colorScheme='blue' size={'lg'} onClick={handleAdd}>Continue to Payment</Button>
                        </Flex>
                    </FormControl>
                </Stack>
