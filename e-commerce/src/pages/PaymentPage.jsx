...
const PaymentPage = () => {
    ...
    const handleClick = () => {
        if (cardname.length < 0 || cardnumber.length < 12 || month.length < 0 || year.length < 0 || securityCode.length < 3) {
            toast({
    ...
    return (
        <div>
            <Stack
                ...
                <Flex width={{ base: '20%', lg: '20%' }} justify={{ base: "center", lg: "flex-start" }} height={'220px'}> <img src={image} alt={'logo'} width={'100%'} height={30} /></Flex>
