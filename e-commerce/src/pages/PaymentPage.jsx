...
const PaymentPage = () => {
    ...
    const handleClick = () => {
        ...
        //e.preventDefault()
        console.log(newData)
        if (cardname.length < 1 || cardnumber.length < 12 || month.length < 0 || year.length < 0 || securityCode.length < 3) {
            toast({
            ...
            <Stack direction={['column', 'row']} justifyContent={'center'} margin={'auto'} spacing={'24px'}
                ...
                <Stack width={'95%'} spacing={'20px'} direction={['column', 'column']}>
                    ...
                    <Stack width={'100%'} p={5} border={'0.1px solid gray'} mb={'40px'} borderRadius={5}>
                        ...
                        <Input placeholder='' type='text' borderRadius={'none'} value={cardname} onChange={(e) => setCardname(e.target.value)} />

                        <Text fontWeight={'bold'}>Card Number</Text>
                        <Input placeholder='' type='number' borderRadius={'none'} value={cardnumber} onChange={(e) => setCardnumber(e.target.value)} />
                        ...
                        <Input placeholder='' type='number' borderRadius={'none'} width={'40%'} value={securityCode} onChange={(e) => setSecurityCode(e.target.value)} />
                    ...
                    <Flex width={'100%'} alignItems={'center'} >
                        <Spacer /><Button colorScheme='blue' size={'lg'} onClick={handleClick}>Continue to Review Order</Button>
                    </Flex>
                </Stack>
